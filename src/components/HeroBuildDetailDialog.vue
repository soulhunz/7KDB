...
// สเตตัสสุทธิ (totals) → primary + secondary
...
// สเตตัสเสริมที่ไม่มีช่องมาตรฐาน (จากเซต/ของรัก)
...
// รูปชิ้นอุปกรณ์: หน้า (idx<2) ตาม attackType, หลัง = imgBack
...
@media (min-width: 520px) { .hb-piece-grid { grid-template-columns: repeat(2, 1fr); } }
</style>
